...
function twentyseventeen_setup() {
  ...
  // or three... _vp_
	...
	$starter_content = array(
      ...
      'top2' => array(
        'name' => __('Top2 Menu', 'twentyseventeen' ),
        'items' => array('link_home'),
      ),
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-56558063-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());
  gtag('config', 'UA-56558063-1');
</script>
<?php
}
...
function twentyseventeen_scripts() {
  ...
  wp_enqueue_script('$',           get_template_directory_uri() . '/assets/js/jquery-3.3.1.min.js' );
  // wp_enqueue_style( 'materialize', get_template_directory_uri() . '/assets/css/materialize.min.css', false, '1.0.0', 'all' );
  // wp_enqueue_script('materialize', get_template_directory_uri() . '/assets/js/materialize.min.js' );
